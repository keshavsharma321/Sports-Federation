...
At Parwah Sports, our mission is to support athletes in reaching their full potential by helping them compete wherever they aspire. We provide training, career guidance in sports, and the resources they need to grow—ensuring every athlete gets a fair chance to shine.      </p>
    </div>
  ...
  <div className="container mx-auto px-4">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      <div className="animate-on-scroll space-y-6">
        <h2 className="section-title">Concerning Parwah Sports Trust</h2>
        <p className="text-muted-foreground">
          At Parwah Sports Trust, we&apos;re committed to helping athletes reach their full potential. Our mission is to support and uplift young talent—emotionally, financially, and professionally.
        </p>
        <div className="space-y-4">
          <div className="bg-white p-4 rounded-lg shadow-sm border border-transparent">
            <h3 className="font-medium mb-2 text-sport-blue">Athlete Support</h3>
            <p className="text-sm text-muted-foreground">
              We offer aspiring and underprivileged athletes financial assistance, emotional support, and mentorship.
            </p>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-sm border border-transparent">
            <h3 className="font-medium mb-2 text-sport-green">Training & Coaching</h3>
            <p className="text-sm text-muted-foreground">
              We provide access to qualified trainers, individualized coaching, and professional training programs.
            </p>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-sm border border-transparent">
            <h3 className="font-medium mb-2 text-sport-purple">School & Academy Collaboration</h3>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm border border-transparent">
            <h3 className="font-medium mb-2 text-sport-red">Talent Development</h3>
            <p className="text-sm text-muted-foreground">
              We find bright young people and set them up for success at the local, state, federal, and even global levels.
            </p>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-sm border border-transparent">
            <h3 className="font-medium mb-2 text-sport-yellow">Community Engagement</h3>
            <p className="text-sm text-muted-foreground">
